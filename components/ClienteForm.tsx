        ...
        <div className="space-y-4">
          ...
          <div>
            <label htmlFor="cli-tel" className={labelCls}>
              Telefone {!rapido && <span className="text-navy-500 dark:text-gibelo-areia">(opcional)</span>}
            </label>
            <input
              id="cli-tel"
              type="tel"
            ...
            <>
              ...
              <div>
                <label htmlFor="cli-obs" className={labelCls}>
                  Observações <span className="text-navy-500 dark:text-gibelo-areia">(opcional)</span>
                </label>
                <textarea
                  id="cli-obs"
                  rows={3}
