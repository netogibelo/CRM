      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-navy-100 bg-white p-4 lg:col-span-2">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-navy-400">funil cumulativo</span>
          </div>
              ...
              <li key={c.deOrigemId}>
                <div className="flex items-center justify-between text-xs">
                  <span className="text-navy-600">
                    {c.deNome} <span className="text-navy-300">→</span>{" "}
                    {c.paraNome}
                  </span>
        ...
        <div className="flex flex-col gap-4">
          <div className="rounded-xl border border-navy-100 bg-white p-4">
            ...
            <p className="mt-1.5 text-xl font-bold tracking-tight text-navy-900">
              {formatBRL(m.valorMedio)}
            </p>
            <p className="mt-0.5 text-xs text-navy-400">ticket médio de ganhos</p>
          </div>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <p
                className={`text-sm font-semibold ${
                  m.paradas > 0 ? "text-amber-900" : "text-navy-700"
                }`}
              >
                {m.paradas}{" "}
            ...
            <p
              className={`mt-1 text-xs ${
                m.paradas > 0 ? "text-amber-700" : "text-navy-400"
              }`}
            >
