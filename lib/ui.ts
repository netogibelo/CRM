...
export const inputCls =
  "mt-1 w-full rounded-lg border border-navy-200 bg-white px-3 py-2 text-sm text-navy-900 shadow-sm transition-colors placeholder:text-navy-500 focus:border-navy-500 focus:outline-none focus:ring-2 focus:ring-navy-500/30 dark:border-dark-border dark:bg-dark-elevated dark:text-gibelo-offwhite dark:placeholder:text-gibelo-areia dark:focus:border-gibelo-areia dark:focus:ring-gibelo-areia/30";
